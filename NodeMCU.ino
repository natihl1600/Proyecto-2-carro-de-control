 ...
 */
#define EnA D5 // potencia que le va a entrar al motor
#define In1 D4 // D4 en HIGH : retroceder
#define In2 D3 // D3 en HIGH : avanzar
#define In3 D2 // D2 en HIGH : girar a la derecha
#define EnB D1 // 
  ...
  if(llave == "pwm"){
    ...
    switch (llave[1]){
      ...
      case 'r':
        ...
        break;
      /**
       * # AGREGAR CASOS CON EL FORMATO l[caracter]:valor; No necesario.
